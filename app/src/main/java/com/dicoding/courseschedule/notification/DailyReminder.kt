...
class DailyReminder : BroadcastReceiver() {
    ...
    fun setDailyReminder(context: Context) {
        ...
        val navigation = Intent(context, DailyReminder::class.java)
        val requestCode = 100
    ...
    private fun showNotification(context: Context, content: List<Course>) {
        ...
        val notificationStyle = buildNotificationStyle(context, content)
        ...
        val builder = buildNotificationBuilder(context, notificationStyle, pendingIntent)
    ...
    private fun buildNotificationStyle(context: Context, content: List<Course>): NotificationCompat.InboxStyle {
